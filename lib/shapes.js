class Triangle {
  ...
  createTriangle() {
    ...
    <text x="50" y="70" font-size="20" fill="${
      this.textColor
    }" text-anchor="middle" alignment-baseline="central">${this.text.toUpperCase()}</text>
  </svg>
    `;
  }
}
...
class Square {
  ...
  createSquare() {
    ...
    <text x="50%"  y="50%" fill="${
      this.textColor
    }" font-size="40" text-anchor="middle" alignment-baseline="central">${this.text.toUpperCase()}</text>
    </svg>
